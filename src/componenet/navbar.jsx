            ...
            <div className=" w-[327px] md:w-[689px] lg:w-[1280px]  flex  items-center justify-between   text-[15px]
             text-[#83888F] ">
                ...
                <div className='flex justify-end gap-10 font-bold'>
                    ...
                    <Link to="" className="hidden cursor-pointer md:block lg:block">ABOUT US</Link>
                    <Link to="" className="hidden cursor-pointer md:block lg:block">CREATE YOUR PLAN</Link>
                ...
                {divOpen && (
                    <div className="absolute top-[75px] left-[3%]  z-10">
                        <div className="space-y-2 w-[275px] shadow-lg font-semibold text-[#1B1D23] bg-[#FFFFFF] mt-4 p-3 rounded-lg text-center text-[25px] pl-5 list-none">
                            ...
                            <Link to="/" className="cursor-pointer w-[140px] p-1 mb-10 rounded-lg hover:bg-gray-100">ABOUT US</Link> <br />
                            <Link to="" className="cursor-pointer w-[140px] p-1 mt-20 rounded-lg hover:bg-gray-100">CREATE YOUR PLAN</Link>
                            <p></p>
                        </div>
                    </div>
                )}
